      ...
      <header className="flex-none pt-12 pb-12 px-6 border-gray-800/50 z-20">
        ...
        <div className="max-w-4xl mx-auto text-center flex flex-col gap-6">
          ...
          <p className="md:text-md text-sm max-w-xl mx-auto leading-relaxed">
            ...
            Cloudflare Workers AI, the application acts as an autonomous
            "ChatOps" agent for NetBox. Instead of manually navigating complex
            web forms or writing curl commands, users can simply state their
            intent—such as "provision the next available IP for a web
            server"—and the agent handles the underlying logic, validation, and
            API execution in real-time.
          </p>
          ...
          <p className="md:text-md text-sm max-w-xl mx-auto leading-relaxed">
            ...
            the LLM determines which specific NetBox tool (querying,
            provisioning, or updating) is required. Once the tool is selected,
            the middleware executes the request against the{" "}
            <Link
            ...
            never has direct access to the database; it must work through the
            same business logic and permissions as a human administrator.
          </p>
          <h2 className="md:text-md font-bold mt-5">
            Data Synthesis and Feedback
          </h2>
          <p className="md:text-md text-sm max-w-xl mx-auto leading-relaxed">
            Once the network action is complete, the raw JSON response from
            NetBox is fed back into the model for Synthesis. This is a critical
            step that transforms technical data into human-readable
            confirmation. The "Architect" reviews the operation’s success or
            failure and explains the outcome—confirming specific IP assignments
            or explaining prefix exhaustion errors. This creates a closed-loop
            system where the network state is not just modified, but clearly
